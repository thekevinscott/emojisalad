...
var content = [
{
   ...
   phrase_2: "EMOJIBOT: Good job, Ari, you got it!<br><br>Alright, Kevin\'s turn."
 },

 {
   ...
   phrase_2: "EMOJIBOT: Good job, Kevin, you got it!<br><br>Alright, Dave\'s turn."
 },

 {
   emoji: "<i class='twa twa-hocho'></i><i class='twa twa-runner'></i>",
   phrase_1: "Reggie: Serial killer",
   phrase_2: "EMOJIBOT: <i class='twa twa-rotating-light'></i>Wrong answer, Reggie!<i class='twa twa-rotating-light'></i><br><br>Does anyone else know it?"
 },

 {
   emoji: "<i class='twa twa-tiger'></i><i class='twa twa-crown'></i>",
   phrase_1: "MICHELLE: Lion King!",
   phrase_2: "EMOJIBOT: Good job, Michelle, you got it!<br><br>Alright, Michelle\'s turn."
 }
