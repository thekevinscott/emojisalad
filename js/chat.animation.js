...
var content = [
{
   ...
   phrase_1: "ARI: The roof is on fire",
   phrase_2: "EMOJIBOT <i class='twa twa-space-invader'></i>: Good job, Ari, you got it!<br>Alright, Kevin\'s turn."
 },

 {
   emoji: "<i class='twa twa-no-entry-sign'></i><i class='twa twa-stew'></i><i class='twa twa-four'></i><i class='twa twa-point-right'></i>",
   phrase_1: "KEVIN: No soup for you!",
   phrase_2: "EMOJIBOT <i class='twa twa-space-invader'></i>: Good job, Kevin, you got it!<br>Alright, Dave\'s turn."
 },

 {
   emoji: "<i class='twa twa-hocho'></i><i class='twa twa-runner'></i>",
   phrase_1: "Reggie: Serial killer",
   phrase_2: "EMOJIBOT <i class='twa twa-space-invader'></i>: <i class='twa twa-rotating-light'></i>Wrong answer, Reggie!<i class='twa twa-rotating-light'></i><br>Michelle, Kevin, Ari, do you know it?"
 },

 {
   emoji: "<i class='twa twa-tiger'></i><i class='twa twa-crown'></i>",
   phrase_1: "MICHELLE: Lion King!",
   phrase_2: "EMOJIBOT <i class='twa twa-space-invader'></i>: Good job, Michelle, you got it!<br>Alright, Michelle\'s turn."
 }
