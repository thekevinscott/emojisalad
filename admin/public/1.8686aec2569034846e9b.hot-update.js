	...
	var Script = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'window jtk-node', id: 'flowchartWindow1' },
	                React.createElement(
	                    'strong',
	                    null,
	                    '1'
	            ...
	            React.createElement(
	                'div',
	                { className: 'window jtk-node', id: 'flowchartWindow2' },
	                React.createElement(
	                    'strong',
	                    null,
	                    '2'
	            ...
	            React.createElement(
	                'div',
	                { className: 'window jtk-node', id: 'flowchartWindow3' },
	                React.createElement(
	                    'strong',
	                    null,
	                    '3'
	            ...
	            React.createElement(
	                'div',
	                { className: 'window jtk-node', id: 'flowchartWindow4' },
	                React.createElement(
	                    'strong',
	                    null,
	                    '4'
