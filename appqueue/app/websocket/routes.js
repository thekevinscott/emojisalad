...
export const START_NEW_GAME = '@GameSettings/START_NEW_GAME';
...
export const INVITE_TO_GAME = '@GameSettings/INVITE_TO_GAME';
export const LOGIN = '@Authentication/SERVER_LOGIN';
