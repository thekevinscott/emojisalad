...
CREATE TABLE `attributes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=126986 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `attributes` VALUES (1,'timestamp','1457154128.687'),(125581,'sms_queue_id','1390');
...
-- Dump completed on 2016-03-27 19:21:50
