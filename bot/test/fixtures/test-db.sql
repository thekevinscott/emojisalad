...
CREATE TABLE `attributes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=128549 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2016-04-30 20:05:08
-- MySQL dump 10.13  Distrib 5.6.29, for osx10.11 (x86_64)
--
-- Host: 45.55.41.73    Database: emojinaryfriend
-- ------------------------------------------------------
...
INSERT INTO `message_variants` VALUES (99,29,'? What a wonderful set of emoji! You are smart, and good looking. I sent your emoji phrase to the group. Let the round begin!','2016-04-30 21:31:35'),(100,29,'? Fantastic set of emoji! I sent your emoji phrase to the group. Let\'s play!','2016-04-30 21:34:27'),(101,31,'Text OPTIONS if you get stuck, and don\'t forget to ask for a CLUE if you get stuck!','2016-04-30 22:17:07'),(102,31,'Text OPTIONS if you get stuck. You can also ask for a CLUE!','2016-04-30 22:17:21'),(103,29,'? Wow, that\'s an awesome emoji set! Let\'s start the round!','2016-04-30 22:25:23'),(104,29,'? Gosh, those are great. Let\'s get started!','2016-04-30 22:25:38'),(105,29,'? Great emoji, I sent along to the group. Let\'s get going!','2016-04-30 22:25:53');
...
-- Dump completed on 2016-04-30 20:05:09
