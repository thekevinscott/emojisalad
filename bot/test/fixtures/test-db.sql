...
CREATE TABLE `attributes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=139798 DEFAULT CHARSET=latin1;
...
CREATE TABLE `timers` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6661 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-11-04  8:21:06
-- MySQL dump 10.13  Distrib 5.6.29, for osx10.11 (x86_64)
--
-- Host: 45.55.41.73    Database: emojinaryfriend
-- ------------------------------------------------------
...
-- Dump completed on 2016-11-04  8:21:10
