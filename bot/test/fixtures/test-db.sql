...
CREATE TABLE `attributes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=129881 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-05-20 13:07:40
-- MySQL dump 10.13  Distrib 5.6.29, for osx10.11 (x86_64)
--
-- Host: 45.55.41.73    Database: emojinaryfriend
-- ------------------------------------------------------
...
-- Dump completed on 2016-05-20 13:07:41
