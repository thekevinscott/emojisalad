...
CREATE TABLE `attributes` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=127219 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `attributes` VALUES (1,'timestamp','1457154128.687'),(125581,'sms_queue_id','1630');
...
-- Dump completed on 2016-03-29  8:45:42
