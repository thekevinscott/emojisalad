    ...
    return playGame(players).then(() => {
      return check(
        ...
        [
          ...
          { key: 'clue_b', options: [players[1].nickname, players[1].avatar, '*'], to: players[0] },
          { key: 'clue_b', options: [players[1].nickname, players[1].avatar, '*'], to: players[1] },
          { key: 'clue_b', options: [players[1].nickname, players[1].avatar, '*'], to: players[2] }
        ]
      );
    });
  });
