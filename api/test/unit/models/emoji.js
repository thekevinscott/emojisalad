...
describe('Emoji', () => {
  describe('getNumOfEmoji', () => {
    it('should return 0 emoji', () => {
      return Emoji.getNumOfEmoji('').should.equal(0);
    });

    it('should return 0 emoji for a string', () => {
      return Emoji.getNumOfEmoji('foo').should.equal(0);
    });

    it('should return 1 emoji for a single emoji', () => {
      return Emoji.getNumOfEmoji(EMOJI).should.equal(1);
    });

    it('should return 2 emoji for 2 emojis', () => {
      return Emoji.getNumOfEmoji(EMOJI + EMOJI).should.equal(2);
    });
  });
