      ...
      return playGame(players).then(function(game) {
        ...
        return check(
          ...
          [
            ...
            { to: players[0], key: 'correct-guess', options: [players[0].nickname, score] },
            { to: players[1], key: 'correct-guess', options: [players[0].nickname, score] },
      ...
      return playGame(players).then(function(game) {
        ...
        return check(
          ...
          [
            ...
            { to: players[0], key: 'correct-guess', options: [players[0].nickname, score] },
            { to: players[1], key: 'correct-guess', options: [players[0].nickname, score] },
            { to: players[2], key: 'correct-guess', options: [players[0].nickname, score] },
      ...
      return startGame(players.slice(0, 3)).then(function(game) {
        ...
        return check(
          ...
          [
            ...
            { to: players[1], key: 'correct-guess', options: [players[0].nickname, score] },
            { to: players[2], key: 'correct-guess', options: [players[0].nickname, score] },
            { to: players[3], key: 'correct-guess', options: [players[0].nickname, score] },
